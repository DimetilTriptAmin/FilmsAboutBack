    ...
    public class ApplicationContext : IdentityDbContext<User, IdentityRole<int>, int>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Film>().HasData(new Film
            {
                ...
                Poster = Encoding.ASCII.GetBytes(Base64Coder.EncodeImg(Path.GetFullPath(@"../FilmsAboutBack/Assets/posters/fight_club.jpg"))),
                Rating = 4.7,
            ...
            modelBuilder.Entity<Film>().HasData(new Film
            {
                ...
                Poster = Encoding.ASCII.GetBytes(Base64Coder.EncodeImg(Path.GetFullPath(@"../FilmsAboutBack/Assets/posters/scarface.jpg"))),
                Rating = 4.8,
            ...
            modelBuilder.Entity<Film>().HasData(new Film
            {
                ...
                Description = "An American expat tries to sell off his highly profitable marijuana empire " +
                    ...
                    "out from under him.",
                Poster = Encoding.ASCII.GetBytes(Base64Coder.EncodeImg(Path.GetFullPath(@"../FilmsAboutBack/Assets/posters/the_gentlemen.jpg"))),
            ...
            modelBuilder.Entity<Film>().HasData(new Film
            {
                ...
                Poster = Encoding.ASCII.GetBytes(Base64Coder.EncodeImg(Path.GetFullPath(@"../FilmsAboutBack/Assets/posters/pulp_fiction.jpg"))),
                Rating = 4.9,
            ...
            modelBuilder.Entity<Film>().HasData(new Film
            {
                ...
                Poster = Encoding.ASCII.GetBytes(Base64Coder.EncodeImg(Path.GetFullPath(@"../FilmsAboutBack/Assets/posters/the_devils_advocate.jpg"))),
